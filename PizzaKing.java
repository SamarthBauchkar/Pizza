...
{                            
  ...
  //Order Method
   public void Order(String pizzaType2,String cheese)
   {
	   ...
	   {
		   System.out.println("Your Veg_Pizza name is :- "+pizza_choice);
		   ...
		   System.out.println("Total Amount:-Rs."+value+"/-");
	   }
	   else
	   {
		   System.out.println("Your Non_Veg_Pizza name is :- "+pizza_choice);
		   System.out.println("Pizza Type:-"+pizza_type1+" :Rs."+order1.get(pizza_type1));
		   System.out.println("Type of crust:- "+crusttype);
		   if(pizzaType2.equals("Large"))
		   {
 ...
 //Order Conform Method
   ...
   {
	  System.out.print("Are you sure? Please enter y for place order");
	  String conform1 = scan.next();
	  if(conform1.equals("y"))
	  {
		  System.out.println("Your order is placed");
		  System.out.println("Thank you!");
		  System.out.println("We are eagerly waiting for you to visit again");
		  conformorder = "Done";
	  }
	  else
	  {
...
//constructor
   public PizzaKing(String choiceVN) {
		super();
...
{
	System.out.print("which type of pizza do you want?:\n"+"Please enter number\n"
	...
	//Increases price
	value = arr.get(pizza_type);
	System.out.println("You selected pizza type as: "+pizza_type);
...
public void crustType() 
{
   ...
   System.out.println("Which Type of crust do you want:\n"
   		+ "   1)New hand tossed\n"
   		+ "   2)Wheat thin crust\n"
   		+ "   3)Cheese Burst\n"
   		+ "   4)Fresh pan pizza\n");
   ...
   System.out.println("You selected crusttype as: "+option+")"+crustType.get(option));
}
//Extra cheese
public String ExtraChessse()
{
	System.out.print("Do you want Extra cheese Rs "+ExtraCheese+" yes OR no (y/n): ");
	...
	{
		System.out.println("Okay..extra cheese is not added");
	}	
	return extracheese;
}
...
//veg Toppings list
	public String  vegTopping(Map<String,Integer> vegtoping)
	{
	 ...
	 //toppings choice
	 System.out.print("Please enter Veg Toppings name: ");
...
//Extra toppings:
	public String  nonvegTopping(Map<String,Integer> non_vegtoping) 
	{
		...
		//toppings choice
		 System.out.print("Please enter non-Veg Toppings Name: ");
...
public void extraTopping(String c,String pizzaType)
{
	...
	{//Veg
	 ...
	 {
		 System.out.println("*****You selected Large Pizza You got Two Toppings free****");
	 ...
	 else
	 {
		 ...
		 //Increases price
		 value += vegtoping.get(extra_veg_toppings);
	...
	{//Non-veg
		...
		else
		{
			String extra_nonveg_toppings = nonvegTopping(non_vegtoping);
			 ...
			 //Increases price
			 value += non_vegtoping.get(extra_nonveg_toppings);
...
public void Veg() 
{
	...
	System.out.println("Please enter name:\n "
			...
			+ "   3)Paneer_Tikka");
	//input
	System.out.print("Enter name which do you want : ");
...
public void nonVeg() 
{
	...
	System.out.println("Enter number which do you want:\n "
			+ "   1)Nonveg_Supreme\n "
			+ "   2)Chicken_Tikka\n "
